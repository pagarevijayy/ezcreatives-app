...
export const SquareBottomImage = ({
  quote,
  author,
  imageURL,
  socialHandle,
...
export const SquareClippedTopImage = ({
  quote,
  author,
  imageURL,
  socialHandle,
...
export const SquareEncircledTopImage = ({
  quote,
  author,
  imageURL,
  socialHandle,
...
export const SquareWisdom = ({ templateData }) => {
  ...
  // subQuote = "Bertrand Russell";
  // imageURL = `https://pbs.twimg.com/media/E3tKe1kVEAI2L45.jpg`;
  // brandHandle = "The Philosophy Quote";

  /** templateConfig: import empty parameters, set default, override defaults with user data */
