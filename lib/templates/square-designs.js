...
export const SquareTwitter = ({ templateData }) => {
  const templateConfig = {
    ...designTemplateConfig,
  ...
  return (
    <div className="design-wrapper">
      <div
        className={
          "w-96 h-96 p-6 flex flex-col items-center justify-center text-left" +
          " " +
          `${templateConfig.bgColorStyles}`
        }
      >
        <div className="bg-white w-full p-4 rounded-lg bg-opacity-95 ">
...
export const SquareQuote = ({ templateData }) => {
  const templateConfig = {
    ...designTemplateConfig,
    mainContentPadding: "px-2",
    mainContentFontStyles: "text-2xl",
    ...templateData,
  };
    ...
    <div className="design-wrapper">
      <div className="p-8 w-96 h-96 flex flex-col justify-between bg-white">
        <div className="my-auto text-left">
          ...
          <p
            className={
              "inline bg-yellow-300 font-poppins italic font-medium leading-relaxed text-gray-700 decoration-clone" +
              " " +
              `${templateConfig.mainContentPadding} ${templateConfig.mainContentFontStyles}`
            }
          >
            {templateConfig.quote}
          </p>
        ...
        <div className="flex items-center mr-0 ml-auto">
          <div className="px-4 text-right">
            ...
            <p className="mt-1 text-xs font-poppins text-gray-500 whitespace-nowrap">
              <span className={`${templateConfig.brandingFontStyles}`}>
                {templateConfig.brandHandle}
              </span>
            </p>
